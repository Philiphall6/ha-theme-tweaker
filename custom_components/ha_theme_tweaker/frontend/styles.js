...
export const SETTING_GROUPS = [
  ...
  },
  {
    ...
    settings: [
      ...
      {
        key: "text_accent_color",
        label: "--text-accent-color",
        type: "color",
        placeholder: "#ffffff",
        cssVariable: "--text-accent-color",
      },
      {
        ...
        type: "color",
        placeholder: "#111827",
        cssVariable: "--primary-background-color",
      },
      {
        ...
        type: "color",
        placeholder: "#1f2937",
        cssVariable: "--secondary-background-color",
      },
      {
        ...
        type: "color",
        placeholder: "#202634",
        cssVariable: "--card-background-color",
      },
      {
        ...
        type: "color",
        placeholder: "#f9fafb",
        cssVariable: "--primary-text-color",
      },
      {
        ...
        type: "color",
        placeholder: "#cbd5e1",
        cssVariable: "--secondary-text-color",
      },
      {
        ...
        type: "color",
        placeholder: "#6b7280",
        cssVariable: "--disabled-text-color",
      },
      {
        key: "divider_color",
        label: "--divider-color",
